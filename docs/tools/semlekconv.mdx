      ...
      <div style={cardBodyStyle}>
        ...
        <div style={{ marginBottom: "35px" }}>
          <FontRenderer
            ...
            text={text ? text.split("").reverse().join("") : "hello"}
          />
        </div>
      </div>
    </div>
...
<FontRenderer
    text=". tei delr konvertr sem u sa vr semlek uei tr latin u pus ."
    rtl
    size="33px"
    color="var(--ifm-color-primary, #794cbd)"
    translit="Tei delr konvertr sem u sa vr semlek wei tr latin u pus"
/>
