...
- Alicia-dei semr semrei-grau u edr lus (Alicia wrote a letter for me)

### RMR

To express company, you can use this verb meaning `to be together with`, `to accompain`.

- Lu-pei tr pai-tek u rmr su! (We went to school with her)
...
## Translating English conjunctions into Arusian

|Conjunction|English|Arusian|
|---|---|---|

## Negative sentences with VEJ SA
