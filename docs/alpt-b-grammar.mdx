...
- **Juwa semreis u Fauwr Ara-ga-lei-dem** (The book was written in English).
...
|Expression | Example (Ro-ma-Sem) | English | 
|---|---|---|
...
### CAPITALIZATION RULES (RO-MA-SEM)
...
<RenderSemlek phrase={"lu juua,s u sa luc ta,s ua, eds r,"}/>

**Lu juuweis u sa luk teis wei edse** (I'm happy for your children)
...
|Order|Ro-ma-sem|Ara-ga-lei-dem|Contexts|
|---|---|---|---|
|SVO|**Kaya-dei dauwr nut u payr pai-nut.**|_Kaya eats food at the restaurant_|Familiar, childish, friendly, informal|
|OSV|**Nut sa Kaya-dei dauwr u payr pai-nut**|_Kaya eats food at the restaurant_ OR _As for food, Kaya eats it at the restaurant_|Perfect for most situations, usually sounds neutral and formal|
