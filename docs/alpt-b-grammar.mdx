...
<RenderSemlek phrase={"jua semra,s u Faor ah gh l eh dem"}/>
...
<RenderSemlek phrase={"vo.m oTras u kijras u sa tara del Faor"}/>

**Vom otras u kijras u sa tara-del fauwr** (The capital is in a state of many people vandalizing)

<RenderSemlek phrase={"la,em umuua,s u sa so Pa, Faor"}/>

**Leyem umuuweis u sa so-pei fauwr** (They are greatly in a state of love)

<RenderSemlek phrase={"uaaa, sa lued u sa tara Pus ua, Faor"}/>
...
:::
<RenderSemlek phrase={"tara del sa lua uaaa,s ua, Faos r,"}/>
...
<RenderSemlek phrase={"lara, Prmr kara lus"}/>

**Larei prmr kara lus** (My head hurts)

<RenderSemlek phrase={"lu sa ta, Prmr"}/>

**Lu sa tei prmr** (You hurt me)

<RenderSemlek phrase={"lu Prmra,s"}/>
...
<RenderSemlek phrase={"aeao vaa, sa lu kor ta, aor"}/>

**Ayau-vai sa lu kor tei auwr** (I made you watch the movie)

<RenderSemlek phrase={"aeao vaa, sa lu ka,r ta, aor"}/>
...
<RenderSemlek phrase={"alu vej sa lua oTras u,a sa la, lua kamr"}/>

**Alu-vej sa luwa otras wei sa lei-luwa kamr** (Therefore, a river doesn't have a lot of water)

<RenderSemlek phrase={"uca, su sa ta, our"}/>
...
|---|---|---|---|
|**sasa tuwek** (immediately)|**Marei kouwas sasa tuwek**|<RenderSemlek phrase={"sa sa tuec"}/> <RenderSemlek phrase={"Mara, kouas"}/>|Act immediately!|
...
<RenderSemlek phrase={"Nepa Naj sa ta, tecr u sa umu Paa, tec sa Fna del paa,s r,"}/>
...
<RenderSemlek phrase={"ta, edras u sa ta, aor fh eh d eh oh lus"}/>

**Tei edras u sa tei auwr videyo lus** (Thanks for watching my video!)

<RenderSemlek phrase={"ta, edras u sa ta, tr Mej- sa lu Pa,"}/>
...
<RenderSemlek phrase={"ta, sa lu ka,elr u sa vej sa NuT sa lu da,ecr ua, edr lru"}/>

**Tei sa lu keyelr u sa vej sa nut sa lu deyekr wei edr lru** (I'm sorry for not giving the dog food)

<RenderSemlek phrase={"ta, sa so ka,elr u sa vej sa seG sa so kamr"}/>
...
<RenderSemlek phrase={"da,ec sa ma lus u,a ta,edr u mr saa, sos"}/>

**Deyek sa ma lus wei teyedr u mr sai sos** (My mom received a gift from her sister)

<RenderSemlek phrase={"vej sa lu ta,edras u sa gao kam da ta ta Ma, da ta ta Ma, dec "}/>
...
<RenderSemlek phrase={"lu our lu tr Mej- . . luua da, Mouas "}/>
...
<RenderSemlek phrase={"Fna del umuua,s u tumr lua kuT"}/>

**Fna-del umuuweis u tumr Luwa-kut** (Fenadel is bigger than Luwa-kut)

<RenderSemlek phrase={"la, lua sa kuT u sa lo lua tums r,"}/>

**Lei-luwa sa kut u sa lo-luwa tumse** (A river is smaller than a sea/ocean)

<RenderSemlek phrase={"ta, trmr vo.m Naaa,s ua, sa lu tums r,"}/>
...
<RenderSemlek phrase={"lru Faor umu"}/>

**Lru fauwr umu** (The dog is in a state of being large/big)

<RenderSemlek phrase={"NuT Faor dao"}/>
...
|---|---|---|
|**UMU-LEI** (big path)|<RenderSemlek phrase={"umu la,"}/>|road|
|**LEI-LUWA** (path water)|<RenderSemlek phrase={"la, lua"}/>|river|
