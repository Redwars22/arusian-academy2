...
**Vej sa tei grus** (You aren't a teacher)
...
## ??? (RIGHT?)
You aren't a dog, right? (how to say this in Aru?)
...
**Nepa-tei vr pai-tek** (Are you coming from school?)

**Su vr mez** (He is coming from the house)
