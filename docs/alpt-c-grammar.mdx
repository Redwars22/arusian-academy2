...
**Su trmr vom naais** (He is becoming a bad person)
...
To form the name of the action in Arusian (the verbal noun), that is, words like 'writing', 'driving', 'eating', etc. you just add **KO-** to the root form without any suffixes (the stem or the bare root).

**Tek** (study) > **Ko-tek** (studying, the study)

**Dau** (mouth) > **Ko-dau** (eating)
